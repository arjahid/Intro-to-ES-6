...
console.log(student.like); //directlly
console.log(student["like"]); //access via proparty name string
const myVariable = "age";
console.log(student[myVariable]); //access via proparty name in variable
//es6
